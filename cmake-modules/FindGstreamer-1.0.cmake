...
FIND_PATH(GSTREAMER_gst_INCLUDE_DIR gst/gst.h
                                    PATHS ${GSTREAMER_DIR}/include /usr/include/gstreamer-1.0 /usr/local/include/gstreamer-1.0
                                    ENV INCLUDE DOC "Directory containing gst/gst.h include file")

FIND_PATH(GSTREAMER_gstconfig_INCLUDE_DIR gst/gstconfig.h
                                          PATHS ${GSTREAMER_DIR}/include ${GSTREAMER_DIR}/lib/include /usr/local/include/gstreamer-1.0 /usr/include/gstreamer-1.0 /usr/local/lib/include/gstreamer-1.0 /usr/lib/include/gstreamer-1.0 /usr/lib/x86_64-linux-gnu/gstreamer-1.0/include
...
FIND_LIBRARY(GSTREAMER_gstallocators_LIBRARY NAMES gstallocators-1.0 libgstallocators-1.0
                                        PATHS ${GSTREAMER_DIR}/bin ${GSTREAMER_DIR}/win32/bin ${GSTREAMER_DIR}/bin/bin C:/gstreamer/bin ${GSTREAMER_DIR}/lib ${GSTREAMER_DIR}/win32/lib /usr/local/lib /usr/lib
                                        ENV LIB
                                        DOC "gstallocators library to link with"
                                        NO_SYSTEM_ENVIRONMENT_PATH)

IF (GSTREAMER_gst_INCLUDE_DIR AND 
	GSTREAMER_gstconfig_INCLUDE_DIR AND
	GSTREAMER_gstapp_LIBRARY AND
	GSTREAMER_gstbase_LIBRARY AND 
	GSTREAMER_gstcontroller_LIBRARY AND
	GSTREAMER_gstpbutils_LIBRARY AND 
	GSTREAMER_gstreamer_LIBRARY AND
	GSTREAMER_gstvideo_LIBRARY AND 
	GSTREAMER_gstallocators_LIBRARY
#   GSTREAMER_gstaudio_LIBRARY AND 
#   GSTREAMER_gstdataprotocol_LIBRARY AND 
#	GSTREAMER_gstinterfaces_LIBRARY AND 
#	GSTREAMER_gstnet_LIBRARY AND
#   GSTREAMER_gstnetbuffer_LIBRARY AND 
#   GSTREAMER_gstriff_LIBRARY AND 
#	GSTREAMER_gstrtp_LIBRARY AND 
#	GSTREAMER_gstrtsp_LIBRARY AND 
#	GSTREAMER_gstsdp_LIBRARY AND
#   GSTREAMER_gsttag_LIBRARY AND 
)
  ...
  SET(GSTREAMER_LIBRARIES ${GSTREAMER_gstapp_LIBRARY} 
...
#						  ${GSTREAMER_gstdataprotocol_LIBRARY} 
#						  ${GSTREAMER_gstinterfaces_LIBRARY}
#                         ${GSTREAMER_gstnet_LIBRARY} 
#						  ${GSTREAMER_gstnetbuffer_LIBRARY} 
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Gstreamer-1.0
	REQUIRED_VARS
